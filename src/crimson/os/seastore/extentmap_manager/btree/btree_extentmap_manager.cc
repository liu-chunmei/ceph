...
BtreeExtentMapManager::get_extmap_root(extmap_root_t &extmap_root, Transaction &t)
{
...
BtreeExtentMapManager::find_lextent(extmap_root_t &extmap_root, Transaction &t,
...
BtreeExtentMapManager::add_lextent(extmap_root_t &extmap_root, Transaction &t, objaddr_t lo,
                                   lext_map_val_t val)
{
...
BtreeExtentMapManager::insert_lextent(extmap_root_t &extmap_root, Transaction &t, ExtMapNodeRef root,
